...
export default class MapHandler {
    ...
    constructor (handlers, onerror) {
        ...
        if (typeof this.handlers?.changeLayerVisibility !== "function") {
            if (typeof onerror === "function") {
                onerror(new Error("Filter MapHandler.constructor: The given handler needs a function 'changeLayerVisibility'"));
            }
        }
