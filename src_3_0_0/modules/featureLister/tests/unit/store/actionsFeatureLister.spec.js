...
describe("modules/featureLister/store/actionsFeatureLister", () => {
    ...
    describe("clickOnFeature", () => {
        it("handles the click event when clicking in a feature in the feature list view", () => {
            ...
            expect(createLayerAddToTreeStub.firstCall.args[1]).to.be.deep.equals(state.layerId);
            expect(createLayerAddToTreeStub.firstCall.args[2]).to.be.deep.equals([state.layer.features[featureIndex]]);
        });
    });
