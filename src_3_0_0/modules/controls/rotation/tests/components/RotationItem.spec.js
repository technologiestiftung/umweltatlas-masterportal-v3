...
describe("src_3_0_0/modules/controls/rotation/components/RotationItem.vue", () => {
    ...
    describe("methods", () => {
        ...
        it("radiansToDegrees", () => {
            ...
            expect(wrapper.vm.radiansToDegrees(0)).to.eql(0);
            expect(wrapper.vm.radiansToDegrees(Math.PI)).to.eql(180);
            expect(wrapper.vm.radiansToDegrees(2 * Math.PI)).to.eql(360);
            expect(wrapper.vm.radiansToDegrees(Math.PI / 2)).to.eql(90);
