...
describe("src_3_0_0/core/menu/MenuContainerHeader.vue", () => {
    ...
    it("should render the component without the title and log an error if a wrong value for the prop side is given", () => {
        ...
        expect(consoleErrorSpy.firstCall.args[0].replace(/[\n\r]+/g, " ")).to.equal("[Vue warn]: Invalid prop: custom validator check failed for prop \"side\". found in ---> <MenuContainerHeader> at src_3_0_0/core/menu/MenuContainerHeader.vue        <Root>");
