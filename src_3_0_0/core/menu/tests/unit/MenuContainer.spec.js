...
describe("src_3_0_0/core/menu/MenuContainer.vue", () => {
    let store;
    ...
    describe("mainMenu", () => {
        it("renders the component but doesnt show it initially and it contains all default elements", () => {
            ...
            expect(mainMenuWrapper.find(MenuContainerHeader).exists()).to.be.true;
            expect(mainMenuWrapper.find(MenuContainerBody).exists()).to.be.true;
    ...
    describe("secondaryMenu", () => {
        it("renders the component but doesnt show it initially and it contains all default elements", () => {
            ...
            expect(secondaryMenuWrapper.find(MenuContainerHeader).exists()).to.be.true;
            expect(secondaryMenuWrapper.find(MenuContainerBody).exists()).to.be.true;
            expect(wrapper.findAll(".menu-container-handle").length).to.equal(1);
