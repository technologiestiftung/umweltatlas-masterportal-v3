...
import {isWebLink} from "../../../js/utils/urlHelper";
import {isPhoneNumber, getPhoneNumberAsWebLink} from "../../../js/utils/isPhoneNumber";
import {isEmailAddress} from "../../../js/utils/isEmailAddress";
