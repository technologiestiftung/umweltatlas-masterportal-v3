...
|filterOnZoom|nein|Boolean||Wenn auf `true` eingestellt, wird den Layer beim Zoom dynamisch gefilteret.|false|
...
|renderer|no|String|"default"|Render-Pipeline für die Darstellung ("default" oder "webgl")(nur für Vektordaten "GeoJSON", "WFS", "OAF", "VectorBase")"webgl" ist derzeit als experimentiell einzustufen.|false|
