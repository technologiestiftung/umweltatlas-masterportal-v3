...
import stateDraw from "@modules/draw_old/store/stateDraw";
...
describe("src/modules/draw/store/actionsDraw.js", () => {
    ...
    describe("createDrawInteractionListener", () => {
        ...
        it("enables the maxFeatures drawstart to dispatch, does so on maxFeatures reached", () => {
            ...
            expect(dispatch.calledWith("Alerting/addSingleAlert", i18next.t("common:modules.draw_old.limitReached", {count: 5}), {root: true}));
