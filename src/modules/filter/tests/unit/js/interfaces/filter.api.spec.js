...
import IntervalRegister from "@modules/filter/utils/intervalRegister";
import InterfaceWfsIntern from "@modules/filter/js/interfaces/interface.wfs.intern";
import InterfaceWfsExtern from "@modules/filter/js/interfaces/interface.wfs.extern";
import InterfaceOafIntern from "@modules/filter/js/interfaces/interface.oaf.intern";
import InterfaceOafExtern from "@modules/filter/js/interfaces/interface.oaf.extern";
import InterfaceGeojsonIntern from "@modules/filter/js/interfaces/interface.geojson.intern";
import InterfaceGeojsonExtern from "@modules/filter/js/interfaces/interface.geojson.extern";
import InterfaceStaIntern from "@modules/filter/js/interfaces/interface.sta.intern";
import InterfaceStaExtern from "@modules/filter/js/interfaces/interface.sta.extern";
import openlayerFunctions from "@modules/filter/utils/openlayerFunctions";
import FilterApi from "@modules/filter/js/interfaces/filter.api";
