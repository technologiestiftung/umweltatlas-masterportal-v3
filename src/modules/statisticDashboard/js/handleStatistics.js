...
function getGroupedCategories (statistics) {
    ...
    Object.values(statistics).forEach(attributesObject => {
        ...
        if (!Object.prototype.hasOwnProperty.call(attributesObject, "categoryGroup")
            ...
            const additionalGroup = groups.find(object => object.name === i18next.t("common:modules.statisticDashboard.filterInputs.additional"));

            if (!additionalGroup) {
                groups.push({
                    name: i18next.t("common:modules.statisticDashboard.filterInputs.additional"),
