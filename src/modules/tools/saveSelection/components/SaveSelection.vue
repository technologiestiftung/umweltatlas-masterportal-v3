...
export default {
    ...
    created () {
        if (Object.prototype.hasOwnProperty.call(Config, "simpleMap")) {
            console.warn("The Parameter 'simpleMap' in the config.js is deprecated in one of the next versions. Please use the parameter 'simpleMap' as part of the configuration of the 'saveSelection' tool in the config.json.");
