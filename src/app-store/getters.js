...
export default {
     ...
     * @returns {Object[]} The layers.
     */
    allSubjectDataLayerConfigs: (context, getters) => {
     ...
     * @returns {Object[]} The layers.
     */
    allBaselayerConfigs: (context, getters) => {
     ...
     */
    configuredModules: (context, getters) => {
        let content = [];
     ...
     */
    maxZIndexOfLayerConfigsByParentKey: (context, getters) => (parentKey) => {
        let maxZIndex = -1;
     ...
     */
    determineZIndex: (context, getters) => (id) => {
     ...
     * @returns {Object[]} The layers.
     */
    invisibleBaselayerConfigs: (context, getters) => {
     ...
     */
    isBaselayer: (context, getters) => layerId => {
     ...
     */
    layerConfigsByAttributes: (context, getters) => (attributes = {}) =>{
     ...
     */
    layerConfigById: (context, getters) => (id) => {
        const layerContainer = getters.allLayerConfigs;
     ...
     */
    layerUrlParams: (context, getters) => {
     ...
     */
    visibleLayerConfigs: (context, getters) => {
        const layerContainer = getters.allLayerConfigs;
     ...
     * @returns {Object[]} Containing all layer configurations with property 'visibility' is true.
     */
    visibleSubjectDataLayerConfigs: (context, getters)=> {
     ...
     */
    visibleBaselayerConfigs: (context, getters) => {
        const layerContainer = getters.allBaselayerConfigs;
